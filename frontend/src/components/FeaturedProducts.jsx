...
const FeaturedProducts = ({ featuredProducts }) => {
  ...
  const isStartEnabled = currentIndex === 0;
  const isEndEnabled = currentIndex >= featuredProducts.length - itemsPerPage;
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-5xl sm:text-6xl font-semibold text-center text-emerald-400 mb-4">
          Featured Products
        </h2>
          ...
          <div className="overflow-hidden">
            ...
            >
              {featuredProducts.map((product) => (
                <div
                  key={product._id}
                  className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 shrink-0 p-2"
                >
