    ...
    <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <AnalyticsCard
          ...
          icon={Package}
          color={"bg-gradient-to-b from-emerald-500 to-green-700"}
        />
        <AnalyticsCard
          title={"Total Sales"}
          value={analyticsData.totalSales.toLocaleString()}
          icon={ShoppingCart}
          color={"bg-gradient-to-b from-emerald-500 to-cyan-700"}
        />
        <AnalyticsCard
          title={"Total Revenue"}
          value={analyticsData.totalRevenue.toLocaleString()}
          icon={DollarSign}
          color={"bg-gradient-to-b from-emerald-500 to-lime-700"}
        />
      </div>
      <motion.div
