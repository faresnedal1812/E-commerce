...
// // TODO: after the testing of all routes => i think this line const existingItem = user.cartItems.find((item) => item.id === productId); must be const existingItem = user.cartItems.find((item) => item.product.toString === productId);
...
//     } else {
//       user.existingItem.push(productId);
//     }
